...
const Login = () => {
  ...
  return (
    <div className="relative flex size-full min-h-screen flex-col bg-[#f8fcfa] group/design-root overflow-x-hidden font-[Inter,_'Noto_Sans',_sans-serif]">
      <div className="layout-container flex h-full grow flex-col">
        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 flex-1">
            <h2 className="text-[#0e1b13] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">Welcome back</h2>
            <p className="text-[#0e1b13] text-base font-normal leading-normal pb-3 pt-1 px-4 text-center">Securing spaces, ensuring peace</p>
              ...
              <div className="flex h-10 flex-1 items-center justify-center rounded-lg bg-[#e7f3ec] p-1">
                <label
                  className={`flex cursor-pointer h-full grow items-center justify-center overflow-hidden rounded-lg px-2 ${
                    userType === 'Admin' ? 'bg-[#f8fcfa] shadow-[0_0_4px_rgba(0,0,0,0.1)] text-[#0e1b13]' : 'text-[#4e976b]'
                ...
                <label
                  className={`flex cursor-pointer h-full grow items-center justify-center overflow-hidden rounded-lg px-2 ${
                    userType === 'Security' ? 'bg-[#f8fcfa] shadow-[0_0_4px_rgba(0,0,0,0.1)] text-[#0e1b13]' : 'text-[#4e976b]'
                  } text-sm font-medium leading-normal`}
                >
            ...
            <p className="text-[#4e976b] text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center underline cursor-pointer">
              Forgot password?
            </p>
          </div>
        </div>
