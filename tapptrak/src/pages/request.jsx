        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f4f0] px-10 py-3">
          ...
          <div class="flex flex-1 justify-end gap-8">
            <div class="flex items-center gap-9">
              ...
              <a class="text-[#111811] text-sm font-medium leading-normal" href="#">Requests</a>
              ...
              <a class="text-[#111811] text-sm font-medium leading-normal" href="#">Settings</a>
            </div>
            <button
            ...
            <div
              ...
              style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuB4uUU4j7CwAWPJbvTl6aAh42InY6GKPsj1bK7sVymLwhQSd-muSK2K3QXfMkX8HmuOs7W5f0ubm85HOjtEINl4Rge_c9gMtCxNbsyOnkyruXYACwNf9dA8eixw3iIt2hNnzBK6-SKgN-IA4YNgDbF5D-Hc8-KpGnSsMKlVZUYVbFQpNdi65poywh02aU2tSk5SsSg_N0LlZF5m2EXeXgVj5_ejlV5f4yd3LBonu0smNulZmreiThyIxsQkyaMMMj8R_OUhwE9e4nOd");'
            ></div>
          </div>
        </header>
          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex min-w-72 flex-col gap-3">
                <p class="text-[#111811] tracking-light text-[32px] font-bold leading-tight">Requests</p>
                <p class="text-[#638863] text-sm font-normal leading-normal">Manage and approve access requests from residents and QR scans.</p>
              </div>
            </div>
              ...
              <div class="flex overflow-hidden rounded-lg border border-[#dce5dc] bg-white">
                <table class="flex-1">
                  ...
                  <tbody>
                    ...
                    <tr class="border-t border-t-[#dce5dc]">
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-120 h-[72px] px-4 py-2 w-[400px] text-[#111811] text-sm font-normal leading-normal">REQ67890</td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-240 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                        2024-07-26 11:30 AM
                      </td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-360 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                      ...
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-480 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                        Electrical
                      </td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-600 h-[72px] px-4 py-2 w-60 text-sm font-normal leading-normal">
                        <button
                    ...
                    <tr class="border-t border-t-[#dce5dc]">
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-120 h-[72px] px-4 py-2 w-[400px] text-[#111811] text-sm font-normal leading-normal">REQ24680</td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-240 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                        2024-07-26 01:00 PM
                      </td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-360 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                    ...
                    <tr class="border-t border-t-[#dce5dc]">
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-120 h-[72px] px-4 py-2 w-[400px] text-[#111811] text-sm font-normal leading-normal">REQ13579</td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-240 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                        2024-07-26 02:45 PM
                      </td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-360 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                    ...
                    <tr class="border-t border-t-[#dce5dc]">
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-120 h-[72px] px-4 py-2 w-[400px] text-[#111811] text-sm font-normal leading-normal">REQ98765</td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-240 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                        2024-07-26 04:20 PM
                      </td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-360 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">
                      ...
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-480 h-[72px] px-4 py-2 w-[400px] text-[#638863] text-sm font-normal leading-normal">Cleaning</td>
                      <td class="table-164353ed-5afb-4cee-855c-4614afc748a5-column-600 h-[72px] px-4 py-2 w-60 text-sm font-normal leading-normal">
                        <button
                          class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-8 px-4 bg-[#f0f4f0] text-[#111811] text-sm font-medium leading-normal w-full"
                        >
