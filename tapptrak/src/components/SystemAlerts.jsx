...
const SystemAlerts = () => {
  ...
  return (
    <>
      {alerts.map((alert) => (
        <div key={alert.id} className="flex items-center gap-4 bg-[#f8fcfa] px-4 min-h-[72px] py-2">
          <div className="text-[#0e1b13] flex items-center justify-center rounded-lg bg-[#e7f3ec] shrink-0 size-12">
